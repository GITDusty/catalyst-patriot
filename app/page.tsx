      ...
      <section className="section-shell relative">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.25fr)_minmax(0,0.75fr)] lg:items-end">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-3 rounded-full border border-slate-200/70 bg-white/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-slate-500 shadow-sm">
              {meta.fiscalYear} Budget Atlas
            </div>
            <h1 className="serif-display mt-6 text-4xl font-semibold text-slate-900 sm:text-5xl">
            ...
            <div className="mt-6 flex flex-wrap gap-3 text-sm">
              <span className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/80 px-4 py-2 font-semibold text-slate-700 shadow-sm">
                Total budget{" "}
                <span className="ledger text-slate-900">
          ...
          <div className="glass-card fade-up rounded-3xl border border-slate-200/70 p-6 shadow-xl">
            ...
            <div className="mt-4 grid gap-4">
              {topCategories.map((category) => (
                <div
                  key={category.name}
                  className="fade-up rounded-2xl border border-slate-100 bg-slate-50/80 p-4"
                >
                  <p className="text-sm font-semibold text-slate-900">
                    {category.name}
                  </p>
                  <p className="ledger mt-2 text-lg font-semibold text-slate-900">
