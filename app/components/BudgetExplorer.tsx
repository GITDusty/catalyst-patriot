  ...
  return (
    <section className="section-shell">
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,0.65fr)]">
        <div className="glass-card fade-up rounded-[2.5rem] border border-slate-200/70 p-8 shadow-[0_40px_120px_-80px_rgba(15,23,42,0.65)]">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">
                {fiscalYear} Florida Budget
              </p>
              <h2 className="serif-display mt-3 text-2xl font-semibold text-slate-900 sm:text-3xl">
